...
namespace eTickets.Migrations
{
    ...
    [Migration("20220212130757_DropUniqueConstrainForAppUserIdInOrderTable")]
    partial class DropUniqueConstrainForAppUserIdInOrderTable
    {
            ...
            modelBuilder.Entity("eTickets.Models.Order", b =>
                {
                    b.HasOne("eTickets.Models.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("eTickets.Models.Order", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
